...
adder_orc_volume_u8 (guint8 * ORC_RESTRICT d1, int p1, int n)
{
  ...
  /* 1: loadpb */
  var35 = (unsigned int) 0x00000080;     /* 128 or 6.32404e-322f */
  /* 3: loadpb */
  var36 = p1;
...
adder_orc_volume_u16 (guint16 * ORC_RESTRICT d1, int p1, int n)
{
  ...
  /* 1: loadpw */
  var35.i = (unsigned int) 0x00008000;   /* 32768 or 1.61895e-319f */
  /* 3: loadpw */
  var36.i = p1;
...
adder_orc_volume_u32 (guint32 * ORC_RESTRICT d1, int p1, int n)
{
  ...
  /* 1: loadpl */
  var35.i = (unsigned int) 0x80000000;   /* -2147483648 or 1.061e-314f */
  /* 3: loadpl */
  var36.i = p1;
