...
#define ORC_UB_MAX 255U
#define ORC_UB_MIN 0
#define ORC_SW_MAX 32767
#define ORC_SW_MIN (-1-ORC_SW_MAX)
#define ORC_UW_MAX 65535U
#define ORC_UW_MIN 0
    ...
    const guint8 * ORC_RESTRICT s1, int n)
{
  ...
  /* 14: loadpl */
  var39.i = (unsigned int) 0x000000ff;   /* 255 or 1.25987e-321f */
    ...
    int n)
{
  ...
  /* 15: loadpl */
  var40.i = (unsigned int) 0xff000000;   /* -16777216 or 2.11371e-314f */
    ...
    const guint8 * ORC_RESTRICT s2, const guint8 * ORC_RESTRICT s3, int n)
{
  ...
  /* 3: loadpb */
  var36 = (unsigned int) 0x000000ff;     /* 255 or 1.25987e-321f */
    ...
    int n)
{
  ...
  /* 2: loadpb */
  var37.x2[0] = (unsigned int) 0x000000ff;       /* 255 or 1.25987e-321f */
  var37.x2[1] = (unsigned int) 0x000000ff;       /* 255 or 1.25987e-321f */
    ...
    const guint8 * ORC_RESTRICT s2, const guint8 * ORC_RESTRICT s3, int n)
{
  ...
  /* 3: loadpb */
  var38.x2[0] = (unsigned int) 0x000000ff;       /* 255 or 1.25987e-321f */
  var38.x2[1] = (unsigned int) 0x000000ff;       /* 255 or 1.25987e-321f */
    ...
    const guint8 * ORC_RESTRICT s1, int n)
{
  ...
  /* 0: loadpb */
  var33 = (unsigned int) 0x000000ff;     /* 255 or 1.25987e-321f */
  /* 3: loadpw */
  var35.i = (unsigned int) 0x00008080;   /* 32896 or 1.62528e-319f */
    ...
    const guint8 * ORC_RESTRICT s2, int n)
{
  ...
  /* 3: loadpb */
  var36.x2[0] = (unsigned int) 0x000000ff;       /* 255 or 1.25987e-321f */
  var36.x2[1] = (unsigned int) 0x000000ff;       /* 255 or 1.25987e-321f */
    ...
    const guint16 * ORC_RESTRICT s1, int n)
{
  ...
  /* 1: loadpw */
  var38.i = (unsigned int) 0x00007c00;   /* 31744 or 1.56836e-319f */
  /* 3: loadpw */
  var39.i = (unsigned int) 0x000003e0;   /* 992 or 4.90113e-321f */
  /* 5: loadpw */
  var40.i = (unsigned int) 0x0000001f;   /* 31 or 1.5316e-322f */
  /* 8: loadpw */
  var41.i = (unsigned int) 0x00000210;   /* 528 or 2.60867e-321f */
  /* 10: loadpw */
  var42.i = (unsigned int) 0x00004200;   /* 16896 or 8.34773e-320f */
  /* 13: loadpw */
  var43.i = (unsigned int) 0x000000ff;   /* 255 or 1.25987e-321f */
    ...
    const guint16 * ORC_RESTRICT s1, int n)
{
  ...
  var40.i = (unsigned int) 0x0000001f;   /* 31 or 1.5316e-322f */
  /* 10: loadpw */
  var41.i = (unsigned int) 0x000000ff;   /* 255 or 1.25987e-321f */
    ...
    const guint32 * ORC_RESTRICT s1, int n)
{
  ...
  /* 1: loadpl */
  var37.i = (unsigned int) 0x0000f800;   /* 63488 or 3.13672e-319f */
  /* 3: loadpl */
  var38.i = (unsigned int) 0x00f80000;   /* 16252928 or 8.03001e-317f */
  /* 5: loadpl */
  var39.i = (unsigned int) 0xf8000000;   /* -134217728 or 2.05568e-314f */
    ...
    const guint32 * ORC_RESTRICT s1, int n)
{
  ...
  /* 1: loadpl */
  var37.i = (unsigned int) 0x00f80000;   /* 16252928 or 8.03001e-317f */
  /* 3: loadpl */
  var38.i = (unsigned int) 0x0000f800;   /* 63488 or 3.13672e-319f */
  /* 5: loadpl */
  var39.i = (unsigned int) 0x000000f8;   /* 248 or 1.22528e-321f */
    ...
    const guint16 * ORC_RESTRICT s1, int n)
{
  ...
  /* 1: loadpw */
  var39.i = (unsigned int) 0x0000f800;   /* 63488 or 3.13672e-319f */
  /* 3: loadpw */
  var40.i = (unsigned int) 0x000007e0;   /* 2016 or 9.96036e-321f */
  /* 5: loadpw */
  var41.i = (unsigned int) 0x0000001f;   /* 31 or 1.5316e-322f */
  /* 9: loadpw */
  var42.i = (unsigned int) 0x00004200;   /* 16896 or 8.34773e-320f */
  /* 11: loadpw */
  var43.i = (unsigned int) 0x00002080;   /* 8320 or 4.11063e-320f */
  /* 14: loadpw */
  var44.i = (unsigned int) 0x000000ff;   /* 255 or 1.25987e-321f */
    ...
    const guint16 * ORC_RESTRICT s1, int n)
{
  ...
  var41.i = (unsigned int) 0x0000001f;   /* 31 or 1.5316e-322f */
  /* 10: loadpw */
  var42.i = (unsigned int) 0x000000ff;   /* 255 or 1.25987e-321f */
    ...
    const guint32 * ORC_RESTRICT s1, int n)
{
  ...
  var37.i = (unsigned int) 0x0000f800;   /* 63488 or 3.13672e-319f */
  /* 3: loadpl */
  var38.i = (unsigned int) 0x00fc0000;   /* 16515072 or 8.15953e-317f */
  /* 5: loadpl */
  var39.i = (unsigned int) 0xf8000000;   /* -134217728 or 2.05568e-314f */
    ...
    const guint32 * ORC_RESTRICT s1, int n)
{
  ...
  var37.i = (unsigned int) 0x00f80000;   /* 16252928 or 8.03001e-317f */
  /* 3: loadpl */
  var38.i = (unsigned int) 0x0000fc00;   /* 64512 or 3.18732e-319f */
  /* 5: loadpl */
  var39.i = (unsigned int) 0x000000f8;   /* 248 or 1.22528e-321f */
    ...
    int p1, int n)
{
  ...
  var38.i = p1;
  /* 8: loadpw */
  var39.i = (unsigned int) 0x00000080;   /* 128 or 6.32404e-322f */
    ...
    int p4, int p5, int n, int m)
{
  ...
  for (j = 0; j < m; j++) {
    ...
    /* 1: loadpb */
    var47.x4[0] = (unsigned int) 0x00000080;     /* 128 or 6.32404e-322f */
    var47.x4[1] = (unsigned int) 0x00000080;     /* 128 or 6.32404e-322f */
    var47.x4[2] = (unsigned int) 0x00000080;     /* 128 or 6.32404e-322f */
    var47.x4[3] = (unsigned int) 0x00000080;     /* 128 or 6.32404e-322f */
    /* 9: loadpw */
    var48.i = p1;
    /* 11: loadpw */
    var49.i = p2;
    ...
    int n)
{
  ...
  /* 1: loadpb */
  var43 = (unsigned int) 0x00000080;     /* 128 or 6.32404e-322f */
  /* 10: loadpw */
  var44.i = p1;
  /* 12: loadpw */
  var45.i = p2;
  /* 16: loadpb */
  var46 = (unsigned int) 0x0000007f;     /* 127 or 6.27463e-322f */
  /* 18: loadpw */
  var47.i = p3;
  /* 22: loadpw */
  var48.i = p4;
  ...
  var49.i = p5;
  /* 31: loadpb */
  var50.x4[0] = (unsigned int) 0x00000080;       /* 128 or 6.32404e-322f */
  var50.x4[1] = (unsigned int) 0x00000080;       /* 128 or 6.32404e-322f */
  var50.x4[2] = (unsigned int) 0x00000080;       /* 128 or 6.32404e-322f */
  var50.x4[3] = (unsigned int) 0x00000080;       /* 128 or 6.32404e-322f */
    ...
    const gint16 * ORC_RESTRICT s3, const gint16 * ORC_RESTRICT s4, int n)
{
  ...
  /* 9: loadpw */
  var38.i = (unsigned int) 0x00000020;   /* 32 or 1.58101e-322f */
    ...
    const gint16 * ORC_RESTRICT s3, const gint16 * ORC_RESTRICT s4, int n)
{
  ...
  /* 11: loadpl */
  var40.i = (unsigned int) 0x00001000;   /* 4096 or 2.02369e-320f */
    ...
    int n)
{
  ...
  var37.i = p1;
  /* 7: loadpw */
  var38.i = (unsigned int) 0x00000080;   /* 128 or 6.32404e-322f */
    ...
    int n)
{
  ...
  var37.i = p1;
  /* 8: loadpl */
  var38.i = (unsigned int) 0x00001000;   /* 4096 or 2.02369e-320f */
    ...
    int n)
{
  ...
  var39.i = p1;
  /* 7: loadpl */
  var40.i = (unsigned int) 0x00000fff;   /* 4095 or 2.0232e-320f */
    ...
    int p2, int p3, int p4, int n)
{
  ...
  var41.i = p4;
  /* 19: loadpw */
  var42.i = (unsigned int) 0x00000020;   /* 32 or 1.58101e-322f */
    ...
    int p2, int p3, int p4, int n)
{
  ...
  var43.i = p4;
  /* 19: loadpl */
  var44.i = (unsigned int) 0x00000fff;   /* 4095 or 2.0232e-320f */
    ...
    const gint32 * ORC_RESTRICT s1, int n)
{
  ...
  /* 1: loadpl */
  var35.i = (unsigned int) 0x00000fff;   /* 4095 or 2.0232e-320f */
    ...
    const gint16 * ORC_RESTRICT s7, int n)
{
  ...
  /* 16: loadpw */
  var41.i = (unsigned int) 0x00000020;   /* 32 or 1.58101e-322f */
    ...
    const gint16 * ORC_RESTRICT s1, int n)
{
  ...
  /* 1: loadpw */
  var34.i = (unsigned int) 0x00000020;   /* 32 or 1.58101e-322f */
    ...
    const gint32 * ORC_RESTRICT s1, int n)
{
  ...
  /* 1: loadpl */
  var34.i = (unsigned int) 0x00000fff;   /* 4095 or 2.0232e-320f */
    ...
    const gint16 * ORC_RESTRICT s5, int p1, int p2, int p3, int p4, int n)
{
  ...
  var41.i = p4;
  /* 21: loadpw */
  var43.i = (unsigned int) 0x00000020;   /* 32 or 1.58101e-322f */
    ...
    const guint8 * ORC_RESTRICT s1, const guint8 * ORC_RESTRICT s2, int n)
{
  ...
  /* 6: loadpw */
  var41.x2[0] = (unsigned int) 0x00000003;       /* 3 or 1.4822e-323f */
  var41.x2[1] = (unsigned int) 0x00000003;       /* 3 or 1.4822e-323f */
  /* 9: loadpw */
  var42.x2[0] = (unsigned int) 0x00000002;       /* 2 or 9.88131e-324f */
  var42.x2[1] = (unsigned int) 0x00000002;       /* 2 or 9.88131e-324f */
    ...
    const guint8 * ORC_RESTRICT s3, const guint8 * ORC_RESTRICT s4, int n)
{
  ...
  /* 17: loadpw */
  var41.x2[0] = (unsigned int) 0x00000004;       /* 4 or 1.97626e-323f */
  var41.x2[1] = (unsigned int) 0x00000004;       /* 4 or 1.97626e-323f */
...
video_orc_dither_fs_muladd_u8 (guint16 * ORC_RESTRICT d1, int n)
{
  ...
  /* 1: loadpw */
  var34.i = (unsigned int) 0x00000005;   /* 5 or 2.47033e-323f */
  /* 6: loadpw */
  var36.i = (unsigned int) 0x00000003;   /* 3 or 1.4822e-323f */
