 ...
 * @buffer: a #GstBuffer
 * @picture_id: the picture id for the frame in this buffer
 *
 ...
 */
GstVideoVP8Meta *
gst_buffer_add_video_vp8_meta (GstBuffer * buffer, guint16 picture_id)
{
  return gst_buffer_add_video_vp8_meta_full (buffer, picture_id, FALSE,
      FALSE, 0, 0);
}
 ...
 */
GstVideoVP8Meta *
gst_buffer_add_video_vp8_meta_full (GstBuffer * buffer, guint16 picture_id,
    ...
    GstBuffer * src, GQuark type, gpointer data)
{
  if (GST_META_TRANSFORM_IS_COPY (type)) {
    ...
    dmeta = gst_buffer_add_video_vp8_meta_full (dst, smeta->picture_id,
