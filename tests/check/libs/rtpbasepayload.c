...
GST_START_TEST (rtp_base_payload_caps_request_not_negotiated)
{
  State *state;
  ...
  push_buffer_fails (state, GST_FLOW_NOT_NEGOTIATED, "pts", 0 * GST_SECOND,
      NULL);
...
rtp_basepayloading_suite (void)
{
  ...
  tcase_add_test (tc_chain, rtp_base_payload_caps_request_not_negotiated);
