...
GST_START_TEST (rtp_base_depayload_caps_request_not_negotiated)
{
  State *state;
...
rtp_basepayloading_suite (void)
{
  ...
  tcase_add_test (tc_chain, rtp_base_depayload_caps_request_not_negotiated);
